...
#
#
#**** Start with construction of intermittent depths
spring=0.05
echo "Calculating intermittent depths"
${queuing_command} ${HCPPIPEDIR}/PostFreeSurfer/scripts/InterSurfaces.sh ${StudyFolder}/${Subject}/T1w/${Subject}/surf ${spring} ${Studyfolder}/${Subject}/T1w/${Subject}/surf
